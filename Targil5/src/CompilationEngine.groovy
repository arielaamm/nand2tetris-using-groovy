...
class CompilationEngine {
    ...
    enum TypeSubroutine {
     ...
     File mInputFile;
     File mOutputFile;
     SymbolTable mClassSymbolTable;
     SymbolTable mSubroutineSymbolTable;
     String mNameCurrentClass;
     String mNameCurrentSubroutine;
     Stack<Character> mStackOperators;
     TypeSubroutine mTypeCurrentSubroutine = TypeSubroutine.NONE;
     boolean isCurrentSubroutineReturnVoid = false;
     int mCountLabelsIf = 0;
     int mCountLabelsWhile = 0;
     int mCountArgs = 0;

    CompilationEngine(File inputFile, File outputFile) {
        mInputFile = inputFile;
        mOutputFile = outputFile;
        println(mInputFile.name)
    }

    def compileClass() throws CompilationEngineException {
    ...
    void compileClassVarDec() throws CompilationEngineException {
    ...
    void compileSubroutine() throws CompilationEngineException {
    ...
    void compileParameterList() throws CompilationEngineException {
        if (mTypeCurrentSubroutine == TypeSubroutine.METHOD) {
    ...
    void compileVarDec() throws CompilationEngineException {
    ...
    void compileStatements() throws CompilationEngineException {
    ...
    void compileDo() throws CompilationEngineException {
    ...
    void compileLet() throws CompilationEngineException {
    ...
    void compileWhile() throws CompilationEngineException {
    ...
    void compileReturn() throws CompilationEngineException {
    ...
    void compileIf() throws CompilationEngineException {
    ...
    void compileExpression() throws CompilationEngineException {
        compileTerm();
    ...
    void compileTerm() throws CompilationEngineException {
        ...
        if (mJackTokenizer.tokenType() == JackTokenizer.TokenType.STRING_CONST) {
            ...
            for (int i = 0; i < str.length(); i++) {
                ...
                mVMWriter.writePush(VMWriter.Segment.CONST, (int)str.charAt(i));
    ...
    void compileExpressionList() throws CompilationEngineException {
        Stack<Character> oldStackOperators = mStackOperators;
        mStackOperators = new Stack<>();
    ...
    private boolean matchTokenType(JackTokenizer.TokenType tokenType) throws CompilationEngineException {
     ...
     def matchSymbol(String symbol) throws CompilationEngineException {
    ...
    //קורא את כל הקובץ ומחזיר את הטקסט, לתוך הבנאי של הטוקנייזר
    ...
    private VMWriter.Segment getSegment(SymbolTable.KindVar kindVar) {
        switch (kindVar) {
            case SymbolTable.KindVar.STATIC: {
                return VMWriter.Segment.STATIC;
            }

            case SymbolTable.KindVar.FIELD: {
                return VMWriter.Segment.THIS;
            }

            case SymbolTable.KindVar.ARG: {
