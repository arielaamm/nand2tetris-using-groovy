class JackTokenizer {
    ...
    JackTokenizer(String inputData) {
    ...
    void advance() {
        //println("mIdentifier: " + mIdentifier + " | mSymbol: " + mSymbol + " mTokenType: " + mTokenType + " mKeyWord: " + mKeyWord + "\n")
        mCurrentState = 0
        ...
        while (true) {
            ...
            switch (mCurrentState) {
                ...
                case 7 : {//מדובר על הערה יש לרוץ על עד סוף השורה ואז לחזור למצב 0
                    if ((mCurrentChar == '\n') || (mCurrentChar == '\0')) {
                        mCurrentState = 0
                    } else {
                        mCurrentState = 7
